...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
			...
			<video src="video/nuevo.mp4"  width=800  height=340 controls autoplay muted></video>
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Productos Destacados</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#Juegos" data-toggle="tab">Juegos</a></li>
...
?>
	...
	<?php } ?>
		...
		<div class="tab-pane" id="Consolas">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">XBOX</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="1">
	<?php
