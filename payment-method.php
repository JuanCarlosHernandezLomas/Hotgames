...
<html lang="es">
	<head>
	    ...
	    <title>Hotgame| Método de Pago</title>
...
<div class="panel panel-default checkout-step-01">
	...
	<input type="radio" name="paymethod" checked value="Debit / Credit card"> Tarjeta de Crédito/Debito<br />
	<br />
	...
	<script>
        ...
        createOrder: function(data,actions){
            return actions.order.create({
                purchase_units:[{
                    amount:{
                        value:<?php echo $totalprice ?>, currency:'MXN'
                    },
					description: "venta de juegos",
                }]
            });
        },
